...
def coletar_fatos():
    ...
    escrever("gemini_debug.json", {
        "docs_na_janela": len(docs),
        "docs_com_texto_pdf": com_texto,
        "lotes_enviados": (len(docs) + FATOS_LOTE - 1) // FATOS_LOTE,
        "lotes_ok": lotes_ok,
        "findings": len(saida),
        "gemini_modelo_usado": _GM["model"],
        "gemini_erro": gemini_erro,
        "tem_key": bool(GEMINI_KEY),
    })
